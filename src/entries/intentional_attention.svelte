...
<h2>28 May 2025</h2>
<p>
	go read the <RainbowLink target="" href="/blog/neoluddite_revolution">first piece</RainbowLink> in
	this series if you want some context, or just keep reading if you're here for the practical deinstagramification
	hacks.
</p>
<h3>context</h3>
<p>
	I hate how I have come to use my phone and the internet more broadly. I think most of you reading
	...
	better one is a worthwhile pasttime. It also does a good deal towards giving people energy <i
		>for</i
	> those fights, rather than paralyzing people into inaction.
</p>
<p>
	IMO: We collectively lack compelling visions of how we could practically make our lives better on
	...
	you're working on in this regard!
</p>
<p>
	Here are some of the strategies I've been tinkering with in the interests of decoupling my
	emotional state from various automatic processes and re-coupling it more intentionally to other
	inputs.
</p>
<h4>reinvent the ipod touch</h4>
<p>
	My favorite suggestion on the list because it rocks (ha). I grabbed an old android phone lying
	around, wiped it, installed <RainbowLink href="https://lineageos.org/">LineageOS</RainbowLink> on it
	...
	me with Caroline Polachek) ever did. Local radio is great, whoulda thought.
</p>
<h4>
	leave your phone in a different room. ideally, stock both rooms with various interesting
	experiences
</h4>
<p>
	Because I can do everything I actually need my phone for during the workday or choreday on my
	...
	you're looking at a flower and petting a cat.
</p>
<h4>periodicals</h4>
<p>
	Subscribing to a few long-form print periodicals and newsletters has helped mitigate my compulsive
	...
	recommendations of new periodicals, especially in print, to subscribe to!
</p>
<h4>harm reduction for the sensory seeking</h4>
<p>
	Sometimes you just want to tip-tap. There are moods where nothing but clicking colorful boxes on a
	...
	sucked into an infinite-scroll socials app? <i>holy Shit, yes.</i>
</p>
<h4>take an exposure break</h4>
<p>
	From Friday sundown to Saturday sundown, my phone is turned off and placed at the back of a
	...
	two after my weekly break.
</p>
<h4>get more (smaller!) social media</h4>
<p>
	My local WhatsApp groups serve the function that Facebook free groups used to with a lot less
	...
	ideally! Probably NextDoor would not work for that purpose though, gotta be judicious....
</p>
<h4>delete socials. just delete your socials</h4>
<p>
	Or as many of them as you can bring yourself to. I cannot tell you how much saner a person I am
	...
	If you can't delete an account, at least delete the app and view it from a browser.
</p>
